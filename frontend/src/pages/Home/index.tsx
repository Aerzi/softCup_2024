    ...
    <>
      <div className="xf-home__page">
        ...
        <main className="xf-home__main">
          <div className="xf-home__main-content">
            ...
            <div className="xf-home__main-content--first">
              <Carousel autoplay arrows>
                <div className="xf-home__main-content--first-carousel">
                  <div className="xf-home__main-content--first-carousel-text">
                    <Title className="xf-home__main-content-text--bold">系统介绍</Title>
                    ...
                    <Paragraph className="xf-home__main-content-text--light">
                      ...
                      <Text className="xf-home__main-content-text--light" strong>更好的用户体验</Text>。
                    </Paragraph>
                  </div>
                </div>
                <div>
              ...
              <div className="xf-home__main-content--first-show">
                <h2 className="xf-home__main-content--first-show-title">产教融合的超级实验开发与运行环境</h2>
                <h3 className="xf-home__main-content--first-show-subtitle">Super Labs Development & Runtime Environment for Industry and Education</h3>
                <TabsInstruction />
              </div>
            </div>
            <Divider />
            <div className="xf-home__main-content--second"></div>
            <Divider />
            <div className="xf-home__main-content--third"></div>
          </div>
        </main>
