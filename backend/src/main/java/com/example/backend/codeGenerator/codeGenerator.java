...
class codeGenerator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/tp_education?characterEncoding=UTF-8&useUnicode=true&useSSL=false", "root", "123456")
                // 全局配置
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("t_programming_assess") // 设置需要生成的表名
